...
public class StoreSQLHelper extends SQLiteOpenHelper {

    public StoreSQLHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
